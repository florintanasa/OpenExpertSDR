...
The [Wiki](https://github.com/florintanasa/OpenExpertSDR/wiki) pages contain detailed information. However, screen captures from the original Genesis SDR project website were lost when the site was closed.
